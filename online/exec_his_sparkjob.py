...
# filenames['ods_soc_traf_raiway_saltic_data']='train'
# filenames['ods_soc_traf_raista_entper']='train'
# filenames['ods_soc_lgs_expr_integ_info']='package'
# filenames['ods_soc_civ_avia_arrport_data']='airline'
# filenames['ods_soc_civ_avia_rese']='airline'
# filenames['ods_soc_civ_avia_leaport_data']='airline'
# filenames['ods_pol_sec_inbord_pers_lodg']='hotel'
# filenames['ods_pol_sec_oversea_pers_lodg']='hotel'
filenames['ods_pol_sec_netbar_intper_info']='internet'
...
increase_files = ['call_msg']
# increase_files = ['hotel','package']
