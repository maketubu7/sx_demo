...
def get_table_index(tablename):
    table_index = {
        ...
        'vertex_domic': 10000000000,	# 户口'  10亿
        ...
        'vertex_alipay':34000000000, # 支付宝10亿
        'vertex_bankcard':35000000000, # 银行卡10亿
        'vertex_house':36000000000, # 房屋10亿
        'vertex_wechat':37000000000, # 微信10亿
        'vertex_sina':38000000000, # 新浪10亿
        'vertex_law_docment':39000000000, # 公司诉讼法律文书10亿  # 80
        'vertex_phonenumber':40000000000,	# 电话 20亿空间 永远在最后，增长最快
    }
...
vertex_table_info['vertex_bankcard'] = ['banknum','khh','sfzh','khrq']
...
vertex_table_info['vertex_law_document'] = ['doc_id','case_code','title','sentence_date','trial_court','case_type',
...
# edge_table_info['edge_find_common_grandian'] = ['sfzh1', 'sfzh2','type_name', 'start_time','end_time']
...
# edge_table_info['edge_find_common_parent'] = ['sfzh1', 'sfzh2','type_name','start_time', 'end_time']
# edge_table_info['edge_person_link_domic'] = ['sfzh', 'domic_num','start_time', 'end_time']
# edge_table_info['edge_find_common_domic'] = ['sfzh1', 'sfzh2','domic_num','start_time', 'end_time']
...
# edge_table_info['edge_person_smz_phone'] = ['start_person', 'end_phone', 'weight', 'start_time', 'end_time']
# edge_table_info['edge_person_open_phone'] = ['sfzh', 'phone', 'start_time', 'end_time','is_xiaohu']
# edge_table_info['edge_person_stay_jail'] = ['sfzh', 'jsbh','ajbh','jyaq', 'start_time','end_time']
...
# edge_table_info['edge_person_link_certificate'] = ['sfzh', 'certificateid','certificate_type','start_time','end_time']
...
# edge_table_info['edge_case_victim_person'] = ['sfzh', 'asjbh', 'start_time','end_time']
# edge_table_info['edge_person_stay_jail'] = ['sfzh', 'jsbh','ajbh','jyaq', 'start_time','end_time']
...
# edge_table_info['edge_case_link_autolpn'] = ['autolpn', 'asjbh', 'start_time','end_time']
# edge_table_info['edge_case_link_person'] = ['sfzh', 'asjbh', 'start_time', 'end_time']
# edge_table_info['edge_case_link_phone'] = ['phone', 'asjbh', 'start_time', 'end_time']
# edge_table_info['edge_case_link_wechat'] = ['wechat', 'asjbh', 'start_time', 'end_time']
# edge_table_info['edge_case_link_qq'] = ['qq', 'asjbh', 'start_time', 'end_time']
edge_table_info['edge_case_link_alipay'] = ['alipay', 'asjbh', 'start_time', 'end_time']
edge_table_info['edge_case_link_banknum'] = ['banknum', 'asjbh', 'start_time', 'end_time']
...
edge_table_info['edge_wechat_link_wechat'] = ['wechat1','wechat2','start_time','end_time']
...
edge_table_info['edge_person_link_sinablog'] = ['sfzh', 'user_account','start_time','end_time']
edge_table_info['edge_phone_link_sinablog'] = ['phone', 'user_account','start_time','end_time']
edge_table_info['edge_qq_link_group'] = ['qq','groupid','start_time','end_time']
edge_table_info['edge_qqgroup_link_banknum'] = ['banknum','groupid','start_time','end_time','relate_num']

## 出行关系
edge_table_info['edge_person_reserve_airline'] = ['sfzh','airlineid','hbh','hbrq','type_name','sfd','mdd','start_time','end_time']
...
edge_table_info['edge_company_workmate'] = ['sfzh1','sfzh2','start_time','end_time','dwmc']
edge_table_info['edge_person_legal_com'] = ['start_person', 'end_company', 'start_time', 'end_time']
edge_table_info['edge_person_work_com'] = ['start_person', 'end_company', 'start_time', 'end_time']
...
edge_info = {
    ...
    ## 家庭关系
    'edge_person_link_domic':['vertex_person','zjhm','vertex_domic','domic_num'],
    'edge_person_kinsfolk_person':['vertex_person','zjhm','vertex_person','zjhm'],
    'edge_find_common_parent':['vertex_person','zjhm','vertex_person','zjhm'],
    ...
    'edge_find_common_grandian': ['vertex_person', 'zjhm', 'vertex_person', 'zjhm'],
    ...
    'edge_find_common_domic': ['vertex_person', 'zjhm', 'vertex_person', 'zjhm'],
    ...
    'edge_person_link_sinablog':['vertex_person','zjhm','vertex_sina','sina'],
    'edge_person_link_wechat':['vertex_person','zjhm','vertex_wechat','wechat'],
    'edge_phone_link_qq':['vertex_phonenumber','phone','vertex_qq','qq'],
    'edge_phone_link_sinablog':['vertex_phonenumber','phone','vertex_sina','sina'],
    'edge_phone_link_wechat':['vertex_phonenumber','phone','vertex_wechat','wechat'],
    'edge_qq_link_qq': ['vertex_qq', 'qq', 'vertex_qq', 'qq'],
    'edge_wechat_link_wechat': ['vertex_wechat', 'wechat', 'vertex_wechat', 'wechat'],
    'edge_qqgroup_link_banknum': ['vertex_bankcard', 'banknum', 'vertex_qq_group', 'groupid'],
    ...
    'edge_person_work_com': ['vertex_person', 'zjhm', 'vertex_company', 'company'],
    'edge_person_surfing_internetbar': ['vertex_person', 'zjhm', 'vertex_internetbar', 'siteid'],
    'edge_person_link_certificate':['vertex_person','zjhm','vertex_certificate','certificateid'],
    ...
    'edge_person_shareholder_com': ['vertex_person', 'zjhm', 'vertex_company', 'company'],
    'edge_com_shareholder_com':['vertex_company','company','vertex_company','company'],
    'edge_accusercom_link_doc':['vertex_law_document','doc_id','vertex_company','company'],
    'edge_defendantcom_link_doc':['vertex_law_document','doc_id','vertex_company','company'],
    'edge_com_lawsuit_com':['vertex_company','company','vertex_company','company'],
    'edge_com_loan_com':['vertex_company','company','vertex_company','company'],
    'edge_company_workmate':['vertex_person','zjhm','vertex_person','zjhm'],

    # 案件关联数据
    'edge_case_link_person': ['vertex_person', 'zjhm', 'vertex_case', 'asjbh'],
    'edge_case_link_phone': ['vertex_phonenumber', 'phone', 'vertex_case', 'asjbh'],
    'edge_case_link_wechat': ['vertex_wechat', 'wechat', 'vertex_case', 'asjbh'],
    'edge_case_link_qq': ['vertex_qq', 'qq', 'vertex_case', 'asjbh'],
    'edge_case_link_alipay': ['vertex_alipay', 'alipay', 'vertex_case', 'asjbh'],
    'edge_case_link_banknum': ['vertex_bankcard', 'banknum', 'vertex_case', 'asjbh'],
    'edge_case_link_autolpn':['vertex_autolpn','autolpn','vertex_case','asjbh'],
    'edge_case_victim_person':['vertex_person','zjhm','vertex_case','asjbh'],
    ...
    'edge_person_stay_jail':['vertex_person','zjhm','vertex_jail','unitid'],
    }


if __name__ == '__main__':
    edge1 = edge_table_info.keys()
    edge2 = vertex_table_info.keys()

    print(len(edge1))
    print(len(edge2))

    for key in edge1:
        print 'hadoop distcp -m 30 -i /phoebus/_fileservice/users/slmp/shulianmingpin/jg_data/%s_jg hdfs://24.1.17.4:8020/user/shulian/graph_data/jg_data/'%key
    for key in edge2:
        print 'hadoop distcp -m 30 -i /phoebus/_fileservice/users/slmp/shulianmingpin/jg_data/%s_jg hdfs://24.1.17.4:8020/user/shulian/graph_data/jg_data/'%key